...
theta, theta1, theta2, theta3, tdot, tdot1, tdot2, tdot3, tdotdot, tdotdot1, tdotdot2, tdotdot3 = symbols('theta theta1 theta2 theta3 qdot qdot1 qdot2 qdot3 qdotdot qdotdot1 qdotdot2 qdotdot3')
L, L1, L2, L3 = symbols('L L1 L2 L3')
m, m1, m2, m3, gr = symbols('m, m1 m2 m3 g')
...
def kin():
    ...
    k1v = m1*(Jv1*col1).T*Jv1*col1
    k1w = (Jw1*col1).T*M1*I1*M1.T*Jw1*col1
    k1 = k1v+k1w

    k2v = m2*Jv2*col2.T*Jv2*col2
...
def main():
    ...
    # task 2e)
    t = tau(D,C,g)
    t_ny = t.subs([(tdot1, 0), (tdot3, 0), (tdot2, tdot), (tdotdot1, 0), (tdotdot3, 0), (tdotdot2, tdotdot), (theta1, 0), (theta3, 0), (theta2, theta), (m3, m), (m2, m), (L2, L), (L3, L), (I1x, 0),(I1y, 0), (I1z, 0), (I3x, 0), (I3y, 0), (I3z, 0)])

    pretty_print(t_ny[1])
    print(simplify(t_ny[1]))
    # print(t_ny.length())
