...
class Node(object):
    def __init__(self):
        ...
        self._out_eff = rospy.Publisher(
                "/crustcrawler/joint1_controller/command", Float64,
                queue_size=5)
        self._out_eff2 = rospy.Publisher(
    ...
    def joint_states_callback(self, states):
        ...
        """
        try:
            index = states.name.index("joint_1")
            ...
            rospy.logwarn("Could not find 'joint_1' in 'joint_states'")
    ...
    def _publish_effort(self, dt):
        ...
        self._out_eff2.publish(self._effort)
